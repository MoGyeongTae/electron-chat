...
class Title extends React.Component {
  ...
  render() {
    return (
      <div className="title">
        <h2 style={{color : "white"}}>현재 채널 ({this.props.channel}채널) - 접속중인 유저 ({this.state.conusers})</h2>
  ...
  render() {
    return (
      <div>
        ...
        <div>
          <input type="file" onChange={this.fileChange}/><button className="btnSend" onClick={this.fileSend}>Upload</button>
        </div>
      </div>
    )
  }
