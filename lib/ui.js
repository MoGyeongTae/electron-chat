  ...
  render() {
    return (
      <div style={{width : "100%", height : "50px" , backgroundColor : "#FF9800" , display : "flex" , justifyContent : "center", alignItems : "center"}}>
        <h2 style={{color : "white"}}>Chat App Title - Current Users ({this.state.conusers})</h2>
      </div>
    )
  }
}
  ...
  render() {
    return (
      <div style={{width : "100%", height : "50px", display : "flex" , justifyContent : "center" , alignItems : "center"}}>
        ...
        <button onClick={this.buttonClick} style={{ border : "none", backgroundColor : "#FF9800", width : "50px", height : "50px" , borderRadius : "3px" , marginLeft : "15px"}}>Send</button>
      </div>
    )
  }
}
